...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { age: @developer.age, company_id: @developer.company_id, email: @developer.email, name: @developer.name } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { age: @developer.age, company_id: @developer.company_id, email: @developer.email, name: @developer.name } }

...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference('Worker.count') do
      post workers_url, params: { worker: { age: @worker.age, name: @worker.name, salary: @worker.salary } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { age: @worker.age, name: @worker.name, salary: @worker.salary } }
